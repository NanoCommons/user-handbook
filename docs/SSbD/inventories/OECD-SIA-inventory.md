...
- [__WSM/WASP7__](https://doi.org/10.1021/acs.est.5b01205): This model evaluates the effect of stream dynamics and chemical transformations on the environmental fate of MNMs in a watershed-scale model. The James River Basin portion of the Phase 5.3.2 Chesapeake Bay Watershed Model (WSM) is coupled with EPA water quality modelling suite WASP7 and configured to model NM fate.   
